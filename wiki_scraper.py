...
#access wiki API. json format. query it for data. search tyep. shows list of possibille articles in JSON Format
...
try:
    ...
    wikipedia_page_tag = data['query']['search'][2]['title']
    print(wikipedia_page_tag)
